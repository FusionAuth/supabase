...
When you are redirected back to the **Applications** page, locate the application you created and click the green magnifying glass to view its details. Find the **OAuth configuration** section and write down both `Client Id` and `Client secret`.
...
Before doing this, you need to grab the **User Ids** from your FusionAuth application, by going to **Users** and clicking **Manage** *(the blueish card icon)* to see the details for a user.
...
- [FusionAuth blog](https://fusionauth.io/blog?utm_source=supabase&utm_medium=guide)
- [FusionAuth documentation](https://fusionauth.io/docs?utm_source=supabase&utm_medium=guide)
