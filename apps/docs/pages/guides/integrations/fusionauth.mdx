...
To make things simpler for this tutorial, we'll only manually add data using the web interface. You can take a look [at these docs](https://supabase.com/docs/reference/javascript/insert) to see how to add data using code.
